...
spell("Blade Ward", "abj", "utility", { range: "self", duration: { units: "round", value: "1" }, source: "PHB", description: "Protege o conjurador por uma rodada contra dano físico causado por ataques de armas.", animation: { file: "jb2a.shield.01.intro.blue" }, status: { id: "blade-ward", label: "Blade Ward", target: "self", changes: [{ key: "system.traits.dr.value", mode: 2, value: "bludgeoning", priority: 20 }, { key: "system.traits.dr.value", mode: 2, value: "piercing", priority: 20 }, { key: "system.traits.dr.value", mode: 2, value: "slashing", priority: 20 }], specialDuration: ["turnStartSource"] } });
spell("Booming Blade", "evo", "utility", { range: 5, properties: ["somatic", "material"], source: "SCAG/TCE", description: "Realiza um ataque com arma envolto em energia trovejante; movimento voluntário posterior pode causar dano adicional.", animation: { file: "jb2a.melee_generic.sword.one_handed", targeted: true, fallbacks: ["jb2a.static_electricity.03.blue"] }, status: { id: "booming-blade", label: "Energia trovejante", specialDuration: ["turnStartSource"] } });
spell("Chill Touch", "nec", "attack", { range: 120, attack: "ranged", damage: [1, 8, "necrotic"], source: "PHB/SRD", description: "Uma mão espectral causa dano necrótico e impede o alvo de recuperar pontos de vida por uma rodada.", animation: { file: "jb2a.ranged.03.projectile.01.dark_purple", targeted: true, fallbacks: ["jb2a.energy_strands.range.standard.dark_purple"] }, status: { id: "chill-touch", label: "Cura bloqueada", changes: [{ key: "flags.midi-qol.noHealing", mode: 5, value: "1", priority: 20 }], specialDuration: ["turnStartSource"] } });
spell("Control Flames", "trs", "utility", { range: 60, properties: ["somatic"], duration: { units: "hour", value: "1" }, target: "space", source: "EE/XGE", description: "Manipula uma chama não mágica, alterando sua forma, luz, tamanho ou extinguindo-a.", animation: { file: "jb2a.fireflies.few.01.orange", fallbacks: ["jb2a.cast_generic.fire.01"] } });
spell("Create Bonfire", "con", "save", { save: "dex", damage: [1, 8, "fire"], range: 60, target: "space", duration: { units: "minute", value: "1" }, concentration: true, source: "EE/XGE", description: "Cria uma fogueira mágica que queima criaturas em seu espaço enquanto a concentração for mantida.", animation: { file: "jb2a.bonfire.01.orange", targeted: true, fallbacks: ["jb2a.fire_trap.02.single.orange"] } });
spell("Dancing Lights", "evo", "utility", { range: 120, duration: { units: "minute", value: "1" }, concentration: true, properties: ["vocal", "somatic", "material"], target: "space", source: "PHB/SRD", description: "Cria até quatro luzes móveis que podem ser controladas enquanto durar a concentração.", animation: { file: "jb2a.dancing_lights.blueyellow", fallbacks: ["jb2a.markers.light_orb.complete.yellow"] } });
spell("Druidcraft", "trs", "utility", { range: 30, source: "PHB/SRD", description: "Produz um pequeno efeito natural, como prever o clima, florescer uma planta ou criar um sinal sensorial.", animation: { file: "jb2a.cast_generic.nature.01", fallbacks: ["jb2a.leaves.outburst.green"] } });
spell("Eldritch Blast", "evo", "attack", { range: 120, attack: "ranged", damage: [1, 10, "force"], source: "PHB/SRD", description: "Dispara um raio de energia arcana; cria raios adicionais conforme o nível do conjurador.", animation: { file: "jb2a.eldritch_blast.purple", targeted: true, fallbacks: ["jb2a.energy_beam.normal.dark_purple"] } });
...
spell("Friends", "enc", "utility", { range: "self", duration: { units: "minute", value: "1" }, concentration: true, properties: ["somatic", "material"], source: "PHB", description: "Concede vantagem temporária em testes sociais contra uma criatura, que percebe a influência ao final.", animation: { file: "jb2a.markers.heart.complete.pink", fallbacks: ["jb2a.magic_signs.rune.enchantment.intro.pink"] }, status: { id: "friends", label: "Friends", target: "self", changes: [{ key: "flags.midi-qol.advantage.skill.cha", mode: 5, value: "1", priority: 20 }], specialDuration: ["turnEndSource"] } });
spell("Frostbite", "evo", "save", { save: "con", damage: [1, 6, "cold"], source: "EE/XGE", description: "Congela momentaneamente o alvo e prejudica o próximo ataque com arma que ele realizar.", animation: { file: "jb2a.ray_of_frost.blue", targeted: true, fallbacks: ["jb2a.impact.frost.blue"] }, status: { id: "frostbite", label: "Frostbite", changes: [{ key: "flags.midi-qol.disadvantage.attack.wak", mode: 5, value: "1", priority: 20 }], specialDuration: ["1Attack", "turnEndSource"] } });
spell("Green-Flame Blade", "evo", "utility", { range: 5, properties: ["somatic", "material"], source: "SCAG/TCE", description: "Um ataque com arma conduz fogo verde ao alvo e, em níveis maiores, a uma segunda criatura próxima.", animation: { file: "jb2a.melee_generic.sword.one_handed.fire.green", targeted: true, fallbacks: ["jb2a.fire_bolt.green"] } });
...
spell("Infestation", "con", "save", { save: "con", damage: [1, 6, "poison"], range: 30, properties: ["vocal", "somatic", "material"], source: "XGE", description: "Invoca parasitas que causam dano venenoso e podem forçar um deslocamento curto e aleatório.", animation: { file: "jb2a.insect_swarm.01.loop.green", targeted: true, fallbacks: ["jb2a.swarm_of_insects.many.01.green"] } });
...
spell("Mage Hand", "con", "utility", { range: 30, duration: { units: "minute", value: "1" }, source: "PHB/SRD", description: "Cria uma mão espectral capaz de manipular objetos leves à distância.", animation: { file: "jb2a.mage_hand.blue", targeted: true, fallbacks: ["jb2a.markers.hand.complete.blue"] } });
spell("Magic Stone", "trs", "attack", { activation: BA, range: 60, attack: "ranged", damage: [1, 6, "bludgeoning"], properties: ["vocal", "somatic"], source: "EE/XGE", description: "Imbui até três pedras; elas podem ser arremessadas ou disparadas para causar dano mágico.", animation: { file: "jb2a.throwable.throw.stone", targeted: true, fallbacks: ["jb2a.boulder.toss.01"] } });
...
spell("Message", "trs", "utility", { range: 120, duration: { units: "round", value: "1" }, properties: ["somatic", "material"], source: "PHB/SRD", description: "Envia uma mensagem sussurrada a uma criatura, que pode responder de modo igualmente discreto.", animation: { file: "jb2a.energy_strands.range.standard.blue", targeted: true, fallbacks: ["jb2a.sending.blue"] } });
spell("Mind Sliver", "enc", "save", { save: "int", damage: [1, 6, "psychic"], properties: ["vocal"], source: "TCE", description: "Fere a mente do alvo e reduz em 1d4 o próximo teste de resistência que ele fizer.", animation: { file: "jb2a.mind_sliver.pink", targeted: true, fallbacks: ["jb2a.impact.004.purple"] }, status: { id: "mind-sliver", label: "Mind Sliver", changes: [{ key: "system.bonuses.abilities.save", mode: 2, value: "-1d4", priority: 20 }], specialDuration: ["isSave", "turnEndSource"] } });
spell("Minor Illusion", "ill", "utility", { range: 30, duration: { units: "minute", value: "1" }, properties: ["somatic", "material"], target: "space", source: "PHB/SRD", description: "Cria um som ou uma imagem ilusória simples e imóvel por até um minuto.", animation: { file: "jb2a.magic_signs.rune.illusion.intro.purple", targeted: true, fallbacks: ["jb2a.smoke.puff.centered.purple"] } });
spell("Mold Earth", "trs", "utility", { range: 30, properties: ["somatic"], target: "space", source: "EE/XGE", description: "Escava, move ou altera visualmente uma pequena porção de terra ou pedra solta.", animation: { file: "jb2a.impact.ground_crack.01.brown", targeted: true, fallbacks: ["jb2a.eruption.01.brown"] } });
spell("Poison Spray", "con", "save", { save: "con", damage: [1, 12, "poison"], range: 10, source: "PHB/SRD", description: "Projeta uma nuvem tóxica de curto alcance contra uma criatura.", animation: { file: "jb2a.poison_spray.dark_green", targeted: true, fallbacks: ["jb2a.cloud_of_daggers.green"] } });
spell("Prestidigitation", "trs", "utility", { range: 10, duration: { units: "hour", value: "1" }, source: "PHB/SRD", description: "Produz pequenos truques mágicos sensoriais, limpa, suja, aquece, resfria ou marca objetos.", animation: { file: "jb2a.magic_signs.rune.transmutation.intro.purple", fallbacks: ["jb2a.sparkles.01.blue"] } });
spell("Primal Savagery", "trs", "attack", { range: "self", attack: "melee", damage: [1, 10, "acid"], properties: ["somatic"], source: "XGE", description: "Transforma dentes ou unhas para realizar um ataque mágico corpo a corpo que causa dano ácido.", animation: { file: "jb2a.claws.400px.green", targeted: true, fallbacks: ["jb2a.liquid.splash.bright_green"] } });
spell("Produce Flame", "con", "attack", { range: 30, attack: "ranged", damage: [1, 8, "fire"], duration: { units: "minute", value: "10" }, source: "PHB/SRD", description: "Cria uma chama na mão que ilumina e pode ser arremessada contra uma criatura.", animation: { file: "jb2a.produce_flame.01.orange", targeted: true, fallbacks: ["jb2a.fire_bolt.orange"] } });
...
spell("Sacred Flame", "evo", "save", { save: "dex", damage: [1, 8, "radiant"], source: "PHB/SRD", description: "Uma chama radiante desce sobre o alvo e ignora benefícios de cobertura no teste de resistência.", animation: { file: "jb2a.sacred_flame.target.yellow", targeted: true, fallbacks: ["jb2a.impact.010.yellow"] } });
spell("Sapping Sting", "nec", "save", { save: "con", damage: [1, 4, "necrotic"], range: 30, source: "EGW", description: "Drena a vitalidade do alvo e o derruba quando ele falha no teste de resistência.", animation: { file: "jb2a.energy_strands.in.dark_purple", targeted: true, fallbacks: ["jb2a.impact.004.dark_purple"] }, status: { id: "prone", label: "Caído", core: true, duration: { turns: 1 } } });
