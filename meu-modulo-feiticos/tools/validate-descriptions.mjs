...
for (const item of pack) {
  ...
  if (isSrd) srdTotal += 1;
    ...
    nonSrdTotal += 1;
    if (quality !== "reviewed-pt-br") nonSrdPending += 1;
  }
...
else console.log(`517 descrições em português: ${reviewedCount} revisadas manualmente e ${translatedCount} com revisão técnica.`);
